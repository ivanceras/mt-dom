    ...
    assert_eq!(
        ...
        vec![
            ChangeText::new(
                &Text::new("item3"),
                PatchPath::new(
                    TreePath::start_at(7, vec![0, 1]),
                    TreePath::start_at(5, vec![0, 1])
                ),
